  ...
  return (
    <div className='w-[300px] bg-white border-3  border-primary  min-h-[375px] rounded-2xl'>
      ...
      <div className='px-2 py-1 flex flex-col justify-center  space-y-1'>
          <p className='text-sm text-primary text-left pl-2 font-semibold '>Rosaline Cake</p>
          ...
          <div className="price mt-1 text-pink-950 font-semibold pl-2 text-left text-xs">
