  ...
  return (
    <div className='w-[300px] bg-white border-3  border-primary  min-h-[375px] rounded-2xl'>
      ...
      <div className='px-2 py-1 flex flex-col justify-center  space-y-1'>
          ...
          <p className="description text-left text-xs w-95/100 self-center font-semibold text-pink-950">A coconut infused cake with a moist three layer ganache with cream toppings.</p>
          <div className="price mt-1 text-pink-950 font-semibold pl-2 text-left text-xs">As from
          <span className='text-primary text-lg font-semibold'> Rs 500 <span className='text-xs'>(10 pax)</span></span>
      </div>
                <OrderCakeModal/>
