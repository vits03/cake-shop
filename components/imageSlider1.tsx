...
export default function ImageSliderCard() {
  ...
  return (
    <div className="relative w-full mx-auto ">
      <div
        className="relative h-[250px] group  overflow-hidden  rounded-b-none "
      ...
      >
        <Image
          ...
          layout="fill"
          objectFit="cover"
          className="transition-all duration-500 ease-in-out cursor-pointer rounded-t-xl"
        />
